...
export const PRESET_ACTIONS = [
  ...
  { action: "Cycled / walked instead of driving", category: "transport", deltaKg: -1.7, icon: "Bike" },
  ...
  { action: "Bought second-hand instead of new", category: "shopping", deltaKg: -1.7, icon: "ShoppingBag" },
