...
export default function Landing({ onStart, hasProfile, onViewDashboard }) {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main
        id="main-content"
        className="flex-1 max-w-5xl mx-auto w-full px-6 flex flex-col justify-center py-16"
      >
        <p className="inline-flex w-fit items-center gap-2 rounded-full bg-teal/10 text-teal px-4 py-1.5 text-sm font-semibold mb-6">
          <Sparkles className="h-4 w-4" aria-hidden="true" /> Your daily climate habit, no login
          needed
        </p>
        ...
        <p className="mt-6 text-lg md:text-xl text-slate max-w-2xl leading-relaxed">
          Most people have no idea what their actual footprint is, and generic “go green” tips never
          say what to do <em>today</em>. EcoPulse turns awareness into a daily loop: a 2-minute
          quiz, a personalized AI action plan, and real, nearby resources to act on it.
        </p>
